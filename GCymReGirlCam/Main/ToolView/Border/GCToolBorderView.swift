...
extension GCToolBorderView {
    ...
    func setupView() {
        ...
        collection.register(cellWithClass: GCBorderCell.self)
    }
    
}

extension GCToolBorderView: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let item = GCDataManager.default.overlayerList[indexPath.item]
        let cell = collectionView.dequeueReusableCell(withClass: GCBorderCell.self, for: indexPath)
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return GCDataManager.default.overlayerList.count
    }
...
extension GCToolBorderView: UICollectionViewDelegateFlowLayout {
...
extension GCToolBorderView: UICollectionViewDelegate {
...
class GCBorderCell: UICollectionViewCell {
